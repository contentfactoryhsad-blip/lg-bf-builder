...
export const PD_SLOT_PLACEMENT: Record<string, PdSlotPlacement> = {
  ...
  'dv360-970x90': { ver: 'v1', art: { x: 95, y: -129, size: 368 },
  ...
  'criteo-468x60': { ver: 'v2', art: { x: 1, y: -74, size: 208 },
  ...
  'criteo-320x50': { ver: 'v2', art: { x: 4.39, y: -45, size: 140 },
  ...
  'dv360-1200x270': { ver: 'v2', art: { x: 423.4, y: -261.49, size: 792.6 },
  ...
  'dv360-320x50': { ver: 'v2', art: { x: 4.38, y: -45, size: 140 },
  ...
  'dv360-728x90': { ver: 'v2', art: { x: 25.96, y: -94, size: 278 },
  ...
  'meta-1080x1440': { ver: 'v2', art: { x: -404, y: -40.5, size: 1912 },
...
export const PD_CENTRIC_PLACEMENT: Record<string, BoardPlacement> = {
  ...
  'criteo-468x60': { art: { x: 7, y: -62, size: 183 } },
  'criteo-970x250': { art: { x: 386, y: -191.44, size: 632.89 }, mask: { angle: 90, stops: [[0, 0], [0.4, 0], [0.61, 1], [1, 1]] } },
  'criteo-728x90': { art: { x: 16, y: -86, size: 261.96 } },
  'criteo-336x280': { art: { x: -78, y: -68.24, size: 491.24 } },
  'criteo-320x480': { art: { x: -181, y: -17, size: 681.56 } },
  'criteo-320x100': { art: { x: 90, y: -83.64, size: 257.27 }, mask: { angle: 90, stops: [[0, 0], [0.36, 0], [0.51, 1], [1, 1]] } },
  'criteo-320x50': { art: { x: -3, y: -48, size: 146.78 } },
  'criteo-300x600': { art: { x: -223, y: 15, size: 747 } },
  'criteo-300x250': { art: { x: -67, y: -58, size: 434 } },
  'criteo-160x600': { art: { x: -121, y: 164, size: 401 } },
  'criteo-120x600': { art: { x: -88, y: 230, size: 296 } },
  'dv360-120x60': { art: { x: 12, y: -39, size: 144.94 }, mask: { angle: 90, stops: [[0, 0], [0.25, 0], [0.51, 1], [1, 1]] } },
  'dv360-125x125': { art: { x: -48.5, y: -34, size: 222 } },
  ...
  'dv360-336x280': { art: { x: -108, y: -94, size: 552 } },
  'dv360-320x320': { art: { x: -120.99, y: -85.43, size: 561.99 } },
  'dv360-360x640': { art: { x: -264, y: -13, size: 888 } },
  'dv360-320x100': { art: { x: 68, y: -95.73, size: 290.72 }, mask: { angle: 90, stops: [[0, 0], [0.36, 0], [0.51, 1], [1, 1]] } },
  'dv360-320x50': { art: { x: -1.23, y: -46.62, size: 145.23 } },
  'dv360-970x250': { art: { x: 383, y: -188, size: 608 } },
  'dv360-728x90': { art: { x: 21.08, y: -86, size: 263.92 } },
  'dv360-300x600': { art: { x: -218, y: 30, size: 734 } },
  'dv360-120x600': { art: { x: -89, y: 231, size: 296 } },
  'dv360-300x250': { art: { x: -89, y: -73.99, size: 477.99 } },
  ...
  'meta-398x208': { art: { x: 112, y: -52.5, size: 377 }, mask: { angle: 90, stops: [[0, 0], [0.36, 0], [0.51, 1], [1, 1]] } },
...
/** Board 001 only. Board 002 draws the Main lockup and shares Main's row. */
