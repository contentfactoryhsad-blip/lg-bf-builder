...
export const PD_SLOT_PLACEMENT: Record<string, PdSlotPlacement> = {
  ...
  'criteo-1024x768': { ver: 'v1', art: { x: -115, y: -445, size: 1658 },
    plates: [P(443, 510, 127.62, 10.05), P(578.31, 510, 127.62, 10.05), P(713.63, 510, 127.62, 10.05), P(848.94, 510, 127.62, 10.05)] },
  ...
  'criteo-480x320': { ver: 'v1', art: { x: -59, y: -227, size: 786 },
    plates: [P(209, 224, 57.69, 4.55), P(270.17, 224, 57.69, 4.55), P(331.34, 224, 57.69, 4.55), P(392.51, 224, 57.69, 4.55)] },
  ...
  'criteo-300x600': { ver: 'v1', art: { x: -318, y: -85, size: 946 },
    plates: [P(19.88, 460, 62.25, 4.9), P(85.88, 460, 62.25, 4.9), P(151.88, 460, 62.25, 4.9), P(217.88, 460, 62.25, 4.9)] },
  'criteo-160x600': { ver: 'v1', art: { x: -149, y: 32, size: 465 },
    plates: [P(47, 300, 65.78, 5.18), P(47, 369.74, 65.78, 5.18), P(47, 439.48, 65.78, 5.18), P(47, 509.22, 65.78, 5.18)] },
  'criteo-120x600': { ver: 'v1', art: { x: -114, y: 94, size: 348 },
  ...
  'dv360-120x240': { ver: 'v1', art: { x: -131, y: -32, size: 386 },
    plates: [P(8, 192, 24.9, 1.96), P(34.4, 192, 24.9, 1.96), P(60.8, 192, 24.9, 1.96), P(87.2, 192, 24.9, 1.96)] },
  ...
  'dv360-300x1050': { ver: 'v1', art: { x: -253, y: 42, size: 808 },
    plates: [P(88, 504, 124, 9.77), P(88, 635.47, 124, 9.77), P(88, 766.94, 124, 9.77), P(88, 898.41, 124, 9.77)] },
  'dv360-160x600': { ver: 'v1', art: { x: -149, y: 32, size: 465 },
    plates: [P(47, 300, 65.78, 5.18), P(47, 369.74, 65.78, 5.18), P(47, 439.48, 65.78, 5.18), P(47, 509.22, 65.78, 5.18)] },
  'dv360-360x640': { ver: 'v1', art: { x: -309, y: -79, size: 982 },
    plates: [P(23.85, 501, 74.7, 5.89), P(103.05, 501, 74.7, 5.89), P(182.25, 501, 74.7, 5.89), P(261.45, 501, 74.7, 5.89)] },
  'dv360-300x600': { ver: 'v1', art: { x: -286, y: -66, size: 878 },
    plates: [P(20.88, 455, 62.25, 4.9), P(86.88, 455, 62.25, 4.9), P(152.88, 455, 62.25, 4.9), P(218.88, 455, 62.25, 4.9)] },
  'dv360-120x600': { ver: 'v1', art: { x: -114, y: 94, size: 348 },
    plates: [P(28, 298, 65, 5.12), P(28, 366.91, 65, 5.12), P(28, 435.83, 65, 5.12), P(28, 504.75, 65, 5.12)] },
  ...
  'meta-1080x1920': { ver: 'v1', art: { x: -1167, y: -564, size: 3434 },
    plates: [P(72, 1544, 224.1, 17.66), P(309.6, 1544, 224.1, 17.66), P(547.2, 1544, 224.1, 17.66), P(784.8, 1544, 224.1, 17.66)] },
