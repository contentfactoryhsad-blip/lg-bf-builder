...
export const PAID_SLOTS: PaidSlot[] = [
  ...
  },
  {
    ...
    text: [
      { role: 'disclaimer', x: 167, y: 47, w: 281, h: 8, size: 6.67, face: 'text', lineHeightPct: null, trackingPct: 0, align: 'left' },
      { role: 'headline', x: 169, y: 5, w: 210, h: 34, size: 16, face: 'headline', lineHeightPct: 106, trackingPct: 0, align: 'left' },
      { role: 'cta', x: 397, y: 26, w: 35, h: 8, size: 8.47, face: 'text', lineHeightPct: 100, trackingPct: 0, align: 'center' },
    ],
  },
  {
  ...
  },
  {
    ...
    text: [
      { role: 'disclaimer', x: 271, y: 70, w: 389, h: 12, size: 10, face: 'text', lineHeightPct: null, trackingPct: 0, align: 'left' },
      { role: 'headline', x: 271, y: 8, w: 300, h: 50, size: 24, face: 'headline', lineHeightPct: 106, trackingPct: 0, align: 'left' },
      { role: 'cta', x: 611, y: 39, w: 54, h: 13, size: 13.07, face: 'text', lineHeightPct: 100, trackingPct: 0, align: 'center' },
    ],
  },
  {
  ...
  },
  {
    ...
    text: [
      { role: 'disclaimer', x: 111, y: 37, w: 197, h: 9, size: 8, face: 'text', lineHeightPct: null, trackingPct: 0, align: 'left' },
      { role: 'headline', x: 113, y: 4, w: 142, h: 26, size: 12, face: 'headline', lineHeightPct: 106, trackingPct: 0, align: 'left' },
      { role: 'cta', x: 273, y: 22, w: 27, h: 6, size: 6.49, face: 'text', lineHeightPct: 100, trackingPct: 0, align: 'center' },
    ],
  },
  {
  ...
  },
  {
    ...
    art: { x: 124, y: -78, size: 246 },
    logo: { x: 15, y: 16, w: 65, h: 29 },
    cta: { x: 822, y: 27, w: 91, h: 36, radius: 7.38 },
    text: [
      { role: 'disclaimer', x: 479, y: 70, w: 471, h: 12, size: 10, face: 'text', lineHeightPct: null, trackingPct: 0, align: 'left' },
      { role: 'headline', x: 483, y: 8, w: 340, h: 50, size: 24, face: 'headline', lineHeightPct: 106, trackingPct: 0, align: 'left' },
      { role: 'cta', x: 839, y: 38, w: 58, h: 14, size: 13.85, face: 'text', lineHeightPct: 100, trackingPct: 0, align: 'center' },
    ],
  },
  {
  ...
  },
  {
    ...
    art: { x: 25, y: -78, size: 246 },
    logo: { x: 12, y: 8, w: 36, h: 16 },
    cta: { x: 595, y: 28, w: 85, h: 34, radius: 6.97 },
    text: [
      { role: 'disclaimer', x: 271, y: 70, w: 389, h: 12, size: 10, face: 'text', lineHeightPct: null, trackingPct: 0, align: 'left' },
      { role: 'headline', x: 271, y: 8, w: 300, h: 50, size: 24, face: 'headline', lineHeightPct: 106, trackingPct: 0, align: 'left' },
      { role: 'cta', x: 611, y: 39, w: 54, h: 13, size: 13.08, face: 'text', lineHeightPct: 100, trackingPct: 0, align: 'center' },
    ],
  },
  {
  ...
  {
    key: 'meta-1080x1440', w: 1080, h: 1440,
    art: { x: -650, y: -264, size: 2384 },
    logo: { x: 33, y: 33, w: 114, h: 50 },
    cta: { x: 447, y: 365, w: 196, h: 78, radius: 16 },
    text: [
      { role: 'disclaimer', x: 30, y: 1375, w: 1020, h: 23, size: 20, face: 'text', lineHeightPct: null, trackingPct: 0, align: 'left' },
      { role: 'headline', x: 145, y: 113, w: 800, h: 144, size: 68, face: 'headline', lineHeightPct: 106, trackingPct: 0, align: 'center' },
      { role: 'subcopy', x: 145, y: 269, w: 800, h: 60, size: 28, face: 'text', lineHeightPct: 106, trackingPct: 0, align: 'center' },
      { role: 'cta', x: 483, y: 389, w: 124, h: 30, size: 30, face: 'text', lineHeightPct: 100, trackingPct: 0, align: 'center' },
    ],
  },
  {
